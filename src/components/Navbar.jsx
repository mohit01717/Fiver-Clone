...
const Navbar = () => {
  ...
  return (
    <div
      className={
        "flex flex-col place-items-center justify-center transition duration-150 ease-in-out sticky top-0 "
      }
      style={{
              ...
              {show && (
                <div className=" absolute top-10 right-50 p-5 bg-white border  text-black flex flex-col w-40">
                  {currentUser?.isSeller && (
                    <>
                      <Link className=" text-gray-400  hover:text-gray-600 font-semibold" to={'/mygigs'}>Gigs</Link>
                      <Link className=" text-gray-400 hover:text-gray-600 font-semibold" to={'/add'}>Add New Gig</Link>
                    </>
                  )}
      ...
      {(active || pathname !=="/") && (
        <>
          ...
          <div className=" w-[1400px] py-3 flex justify-between text-gray-500 font-light   ">
           <Link className=" text-gray-400 font-serif hover:text-[17px] hover:text-gray-500 transition-transform " to='/'>
            Graphics & Design
           </Link>
           <Link className=" text-gray-400 font-serif hover:text-[20px] hover:text-gray-500 transition-transform" to='/'>
            Video & Animation
           </Link>
           <Link className=" text-gray-400 font-serif hover:text-[20px] hover:text-gray-500 transition-transform" to='/'>
            Writing & Translation
